...
/* A Kruskall Tree is a bunch of components.  
 * A tree is full when; 
 * A. It has all the vertices. 
...
public boolean isTreefull(int a_length)
{
	System.out.println(this.verticesinsertIndex);
	System.out.println(a_length);
	if(this.verticesinsertIndex==a_length)
	{
...
/* This is the function that is most likely to throw errors. 
 * 
 * 
 */
